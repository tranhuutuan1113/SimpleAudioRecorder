...
import com.ph.audiorecorder.util.OnCopyListener
import com.ph.audiorecorder.util.copyFileToDir
...
class MoveRecordsService : Service() {
	...
	companion object {
		...
		private const val CHANNEL_ID = "com.ph.audiorecorder.MoveRecords.Notification"
